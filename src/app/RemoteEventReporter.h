 ...
 *
 */
class RemoteEventReporter
{
public:
    virtual ~RemoteEventReporter() = default;
     ...
     */
    virtual CHIP_ERROR NewEventGenerated(ConcreteEventPath & aPath, uint8_t * buf, uint32_t aBytesConsumed) = 0;
};
