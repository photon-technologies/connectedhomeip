...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeResetCounterTimeoutID MTR_PROVISIONALLY_AVAILABLE = 0x0000000C,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeDisplayActiveTimeoutID MTR_PROVISIONALLY_AVAILABLE = 0x0000000D,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeDisplayErrorTimeoutID MTR_PROVISIONALLY_AVAILABLE = 0x0000000E,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeDisplayTargetTimeoutID MTR_PROVISIONALLY_AVAILABLE = 0x0000000F,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeTemperatureSensorMinValidID MTR_PROVISIONALLY_AVAILABLE = 0x00000011,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeTemperatureSensorMaxValidID MTR_PROVISIONALLY_AVAILABLE = 0x00000012,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeOverheatThresholdTemperatureID MTR_PROVISIONALLY_AVAILABLE = 0x00000013,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeRapidRiseDeltaID MTR_PROVISIONALLY_AVAILABLE = 0x00000014,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeRapidRiseWindowID MTR_PROVISIONALLY_AVAILABLE = 0x00000015,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributePreviousTargetHeaterTemperatureID MTR_PROVISIONALLY_AVAILABLE = 0x00000016,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeHeaterMaximumPowerID MTR_PROVISIONALLY_AVAILABLE = 0x00000017,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeDiagnosticsConfirmTimeListID MTR_PROVISIONALLY_AVAILABLE = 0x00000018,
    MTRAttributeIDTypeClusterFreshWaterHeaterControllerAttributeDiagnosticsRehabTimeListID MTR_PROVISIONALLY_AVAILABLE = 0x00000019,
