...
class FreshWaterHeaterControllerClusterWaterHeaterBoostInfoStruct (
    val duration: ULong,
  ...
  override fun toString(): String  = buildString {
    append("FreshWaterHeaterControllerClusterWaterHeaterBoostInfoStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : FreshWaterHeaterControllerClusterWaterHeaterBoostInfoStruct {
      ...
      return FreshWaterHeaterControllerClusterWaterHeaterBoostInfoStruct(duration, oneShot, emergencyBoost, temporarySetpoint, targetPercentage, targetReheat)
    }
  }
}
