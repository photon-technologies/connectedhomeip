...
class FreshWaterHeaterErrorsAlarmClusterNotifyEvent(
  val active: ULong,
  val inactive: ULong,
  val state: ULong,
  val mask: ULong,
  ...
  override fun toString(): String = buildString {
    append("FreshWaterHeaterErrorsAlarmClusterNotifyEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): FreshWaterHeaterErrorsAlarmClusterNotifyEvent {
      ...
      return FreshWaterHeaterErrorsAlarmClusterNotifyEvent(active, inactive, state, mask)
    }
  }
}
