...
class GeneralCommissioningCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class SetTCAcknowledgementsResponse(
    val errorCode: UByte
  )
class BasicCommissioningInfoAttribute(
  ...
  sealed class BasicCommissioningInfoAttributeSubscriptionState {
    data class Success(
    val value: GeneralCommissioningClusterBasicCommissioningInfo
    ) : BasicCommissioningInfoAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : BasicCommissioningInfoAttributeSubscriptionState()

    object SubscriptionEstablished : BasicCommissioningInfoAttributeSubscriptionState()    
  }  
class TCUpdateDeadlineAttribute(
    val value: UInt?
  )
  ...
  sealed class TCUpdateDeadlineAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : TCUpdateDeadlineAttributeSubscriptionState()
...
class NetworkRecoveryReasonAttribute(
    val value: UByte?
  )
  ...
  sealed class NetworkRecoveryReasonAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : NetworkRecoveryReasonAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun armFailSafe(expiryLengthSeconds: UShort
      ,breadcrumb: ULong
      ,timedInvokeTimeout: Duration? = null): ArmFailSafeResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ERROR_CODE)) {errorCode_decoded = tlvReader.getUByte(tag)}  
      
      if (tag == ContextSpecificTag(TAG_DEBUG_TEXT)) {debugText_decoded = tlvReader.getString(tag)}  
  ...
  suspend fun setRegulatoryConfig(newRegulatoryConfig: UByte
      ,countryCode: String
      ,breadcrumb: ULong
      ,timedInvokeTimeout: Duration? = null): SetRegulatoryConfigResponse {
  ...
  suspend fun commissioningComplete(timedInvokeTimeout: Duration? = null): CommissioningCompleteResponse {
  ...
  suspend fun setTCAcknowledgements(TCVersion: UShort
      ,TCUserResponse: UShort
      ,timedInvokeTimeout: Duration? = null): SetTCAcknowledgementsResponse {
...
suspend fun readBreadcrumbAttribute(): ULong {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Breadcrumb attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Breadcrumb attribute not found in Node State update" 
          }
...
suspend fun readBasicCommissioningInfoAttribute(): BasicCommissioningInfoAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Basiccommissioninginfo attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: GeneralCommissioningClusterBasicCommissioningInfo = GeneralCommissioningClusterBasicCommissioningInfo.fromTlv(AnonymousTag, tlvReader)
  ...
  suspend fun subscribeBasicCommissioningInfoAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<BasicCommissioningInfoAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BasicCommissioningInfoAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Basiccommissioninginfo attribute not found in Node State update" 
          }
          ...
          emit(BasicCommissioningInfoAttributeSubscriptionState.Success(decodedValue))
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(BasicCommissioningInfoAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readRegulatoryConfigAttribute(): UByte {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Regulatoryconfig attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Regulatoryconfig attribute not found in Node State update" 
          }
...
suspend fun readLocationCapabilityAttribute(): UByte {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Locationcapability attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Locationcapability attribute not found in Node State update" 
          }
...
suspend fun readSupportsConcurrentConnectionAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Supportsconcurrentconnection attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Supportsconcurrentconnection attribute not found in Node State update" 
          }
...
suspend fun readTCAcceptedVersionAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Tcacceptedversion attribute not found in response" 
    }
  ...
  suspend fun subscribeTCAcceptedVersionAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tcacceptedversion attribute not found in Node State update" 
          }
...
suspend fun readTCMinRequiredVersionAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Tcminrequiredversion attribute not found in response" 
    }
  ...
  suspend fun subscribeTCMinRequiredVersionAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<UShortSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tcminrequiredversion attribute not found in Node State update" 
          }
...
suspend fun readTCAcknowledgementsAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Tcacknowledgements attribute not found in response" 
    }
  ...
  suspend fun subscribeTCAcknowledgementsAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<UShortSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tcacknowledgements attribute not found in Node State update" 
          }
...
suspend fun readTCAcknowledgementsRequiredAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Tcacknowledgementsrequired attribute not found in response" 
    }
  ...
  suspend fun subscribeTCAcknowledgementsRequiredAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<BooleanSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tcacknowledgementsrequired attribute not found in Node State update" 
          }
...
suspend fun readTCUpdateDeadlineAttribute(): TCUpdateDeadlineAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Tcupdatedeadline attribute not found in response" 
    }
  ...
  suspend fun subscribeTCUpdateDeadlineAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TCUpdateDeadlineAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Tcupdatedeadline attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(TCUpdateDeadlineAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRecoveryIdentifierAttribute(): ByteArray? {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Recoveryidentifier attribute not found in response" 
    }
...
suspend fun readNetworkRecoveryReasonAttribute(): NetworkRecoveryReasonAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Networkrecoveryreason attribute not found in response" 
    }
  ...
  suspend fun subscribeNetworkRecoveryReasonAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NetworkRecoveryReasonAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(NetworkRecoveryReasonAttributeSubscriptionState.Success(it))
          }
