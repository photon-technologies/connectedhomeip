...
class FreshMideaAirConditionerAlarmCluster(private val controller: MatterController, private val endpointId: UShort) {class GeneratedCommandListAttribute(
    val value: List<UInt>
  )
...
suspend fun readMaskAttribute(): ULong {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readLatchAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 1u
...
suspend fun readStateAttribute(): ULong {val ATTRIBUTE_ID: UInt = 2u
...
suspend fun readSupportedAttribute(): ULong {val ATTRIBUTE_ID: UInt = 3u
...
suspend fun readClusterRevisionAttribute(): UShort {val ATTRIBUTE_ID: UInt = 65533u
  ...
  companion object {
    private val logger = Logger.getLogger(FreshMideaAirConditionerAlarmCluster::class.java.name)
    const val CLUSTER_ID: UInt = 367524865u
  }
}
