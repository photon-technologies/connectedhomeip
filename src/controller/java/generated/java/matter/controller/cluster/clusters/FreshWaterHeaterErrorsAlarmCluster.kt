...
class FreshWaterHeaterErrorsAlarmCluster(private val controller: MatterController, private val endpointId: UShort) {class GeneratedCommandListAttribute(
    val value: List<UInt>
  )
...
suspend fun readClusterRevisionAttribute(): UShort {val ATTRIBUTE_ID: UInt = 65533u
  ...
  companion object {
    private val logger = Logger.getLogger(FreshWaterHeaterErrorsAlarmCluster::class.java.name)
    const val CLUSTER_ID: UInt = 367524870u
  }
}
