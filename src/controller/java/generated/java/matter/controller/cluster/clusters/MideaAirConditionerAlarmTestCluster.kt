...
class MideaAirConditionerAlarmTestCluster(
  ...
  companion object {
    private val logger = Logger.getLogger(MideaAirConditionerAlarmTestCluster::class.java.name)
    const val CLUSTER_ID: UInt = 4294048769u
  }
}
