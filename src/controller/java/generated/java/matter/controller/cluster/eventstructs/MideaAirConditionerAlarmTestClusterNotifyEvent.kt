...
class MideaAirConditionerAlarmTestClusterNotifyEvent(
  val active: ULong,
  val inactive: ULong,
  val state: ULong,
  val mask: ULong,
  ...
  override fun toString(): String = buildString {
    append("MideaAirConditionerAlarmTestClusterNotifyEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): MideaAirConditionerAlarmTestClusterNotifyEvent {
      ...
      return MideaAirConditionerAlarmTestClusterNotifyEvent(active, inactive, state, mask)
    }
  }
}
