...
class SupportedStreamUsagesAttribute(
  ...
  sealed class SupportedStreamUsagesAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>
    ) : SupportedStreamUsagesAttributeSubscriptionState()
...
class StreamUsagePrioritiesAttribute(
    val value: List<UByte>
  )
  ...
  sealed class StreamUsagePrioritiesAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>
    ) : StreamUsagePrioritiesAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun snapshotStreamModify(snapshotStreamID: UShort
      ,watermarkEnabled: Boolean?
      ,OSDEnabled: Boolean?
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readMaxConcurrentEncodersAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Maxconcurrentencoders attribute not found in response" 
    }
...
suspend fun readNightVisionUsesInfraredAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Nightvisionusesinfrared attribute not found in response" 
    }
...
suspend fun readSnapshotCapabilitiesAttribute(): SnapshotCapabilitiesAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Snapshotcapabilities attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterSnapshotCapabilitiesStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<CameraAvStreamManagementClusterSnapshotCapabilitiesStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(CameraAvStreamManagementClusterSnapshotCapabilitiesStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun subscribeSnapshotCapabilitiesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SnapshotCapabilitiesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SnapshotCapabilitiesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSupportedStreamUsagesAttribute(): SupportedStreamUsagesAttribute {val ATTRIBUTE_ID: UInt = 14u
    ...
    requireNotNull(attributeData) { 
      "Supportedstreamusages attribute not found in response" 
    }
  ...
  suspend fun subscribeSupportedStreamUsagesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SupportedStreamUsagesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readStreamUsagePrioritiesAttribute(): StreamUsagePrioritiesAttribute {val ATTRIBUTE_ID: UInt = 18u
    ...
    requireNotNull(attributeData) { 
      "Streamusagepriorities attribute not found in response" 
    }
  ...
  suspend fun subscribeStreamUsagePrioritiesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StreamUsagePrioritiesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
