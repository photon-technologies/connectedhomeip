...
struct TypeInfo
{
    using Type             = chip::BitMask<chip::app::Clusters::FreshWaterHeaterErrorsAlarm::AlarmBitmap>;
    using DecodableType    = chip::BitMask<chip::app::Clusters::FreshWaterHeaterErrorsAlarm::AlarmBitmap>;
    using DecodableArgType = chip::BitMask<chip::app::Clusters::FreshWaterHeaterErrorsAlarm::AlarmBitmap>;

    static constexpr ClusterId GetClusterId() { return Clusters::FreshWaterHeaterErrorsAlarm::Id; }
...
struct TypeInfo
{
    struct DecodableType
    {
        ...
        Attributes::Mask::TypeInfo::DecodableType mask =
            static_cast<chip::BitMask<chip::app::Clusters::FreshWaterHeaterErrorsAlarm::AlarmBitmap>>(0);
