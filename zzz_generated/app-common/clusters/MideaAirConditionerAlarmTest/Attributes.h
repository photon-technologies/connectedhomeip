...
#include <clusters/MideaAirConditionerAlarmTest/ClusterId.h>
...
struct TypeInfo
{
    using Type             = chip::BitMask<chip::app::Clusters::MideaAirConditionerAlarmTest::AlarmBitmap>;
    using DecodableType    = chip::BitMask<chip::app::Clusters::MideaAirConditionerAlarmTest::AlarmBitmap>;
    using DecodableArgType = chip::BitMask<chip::app::Clusters::MideaAirConditionerAlarmTest::AlarmBitmap>;

    static constexpr ClusterId GetClusterId() { return Clusters::MideaAirConditionerAlarmTest::Id; }
...
struct TypeInfo
{
    struct DecodableType
    {
        ...
        Attributes::Mask::TypeInfo::DecodableType mask =
            static_cast<chip::BitMask<chip::app::Clusters::MideaAirConditionerAlarmTest::AlarmBitmap>>(0);
