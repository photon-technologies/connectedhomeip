...
struct TypeInfo
{
    using Type             = chip::BitMask<chip::app::Clusters::FreshRefrigeratorErrorsAlarm::AlarmBitmap>;
    using DecodableType    = chip::BitMask<chip::app::Clusters::FreshRefrigeratorErrorsAlarm::AlarmBitmap>;
    using DecodableArgType = chip::BitMask<chip::app::Clusters::FreshRefrigeratorErrorsAlarm::AlarmBitmap>;

    static constexpr ClusterId GetClusterId() { return Clusters::FreshRefrigeratorErrorsAlarm::Id; }
...
struct TypeInfo
{
    struct DecodableType
    {
        ...
        Attributes::Mask::TypeInfo::DecodableType mask =
            static_cast<chip::BitMask<chip::app::Clusters::FreshRefrigeratorErrorsAlarm::AlarmBitmap>>(0);
